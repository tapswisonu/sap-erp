...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ error: "Failed to create dispatch detail" }, { status: 500 });
  }
}
...
export async function PUT(request: Request) {
  try {
    ...
    return NextResponse.json({ error: "Failed to update dispatch detail" }, { status: 500 });
  }
}
...
export async function DELETE(request: Request) {
  try {
    ...
    return NextResponse.json({ error: "Failed to delete dispatch detail" }, { status: 500 });
  }
}
